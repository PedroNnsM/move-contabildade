  ...
  return (
    <div className="flex flex-col w-full max-w-md p-8 space-y-8 text-center bg-move-white border-2 border-move-blue-900 rounded-3xl lg:mx-4 shadow-2xl shadow-move-blue-900 ">
      ...
      <button className="text-move-gray-100 bg-move-blue-900 xl  rounded-xl text-sm text-center lg:text-base group">
        <a className='block box-border border-2 border-move-blue-900 rounded-xl py-3 px-6 bg-move-blue-500  text-move-gray-100 translate-y-[-0.2em] ease-in duration-100 group-hover:translate-y-[-0.33em] group-active:translate-y-0' href='https://api.whatsapp.com/send?phone=5547988856568&text=Ol%C3%A1,%20quero%20conhecer%20mais%20os%20servi%C3%A7os%20da%20Move!' target='_blank'>{textBtn}</a>
      </button>
    </div>

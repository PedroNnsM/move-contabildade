  ...
  return (
    <header className="border-b border-gray-300 py-2  ">
      <div className="flex items-center justify-between xl:max-w-6xl xl:mx-auto max-w-full px-[8%] xl:p-0 flex-wrap w-full relative transition ease-in-out delay-150">
        ...
        {open ? (
          <RiCloseFill
            className="lg:hidden block h-8 w-8 text-move-blue-500 cursor-pointer"
        ...
        >
          ...
          <ul className="flex items-center justify-center gap-3">
            <li>
              <button className=" ">
                <a
                  href="https://www.instagram.com/movecontdigital/"
                  target="_blank"
                >
            ...
            <li>
              <button className=" ">
                <a
                  href="https://www.linkedin.com/company/move-assessoria-e-contabilidade-digital/"
                  target="_blank"
                >

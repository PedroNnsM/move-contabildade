...
export function Header() {
  return (
    <section
      id="inicio"
      className="lg:flex lg:w-full lg:h-[600px]   justify-between xl:max-w-6xl xl:mx-auto max-w-full"
    >
      <div className="mx-4  bg-slate-50 z-10 relative flex flex-col items-center gap-6 mt-8 ">
        ...
        <div className="max-w-[350px]">
          <p className="font-normal text-center text-base">
            Aqui na move você encontra soluções que irão auxiliar a alavancar
            seu negócio!
          </p>
        </div>
        <div className="flex justify-center items-center flex-col gap-4 mt-8 lg:flex-row ">
          <BotaoAbrirMinhaEmpresa
            color="text-move-gray-100"
            text="Abrir minha empresa"
          />

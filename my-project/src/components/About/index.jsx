    ...
    return (
      ...
      <section id='sobre' className="bg-move-white dark:bg-move-blue-900">
        <div className="max-w-6xl px-6 py-10 mx-auto">
          ...
          <h1 className="mt-2 text-3xl font-semibold text-move-white capitalize lg:text-4xl  dark:text-move-white">
            Quem somos ?
          </h1>
          <main className="relative z-20 w-full mt-8 md:flex md:items-center xl:mt-12">
            ...
            <div className="w-full p-6 bg-move-blue-500 md:flex md:items-center rounded-2xl md:bg-transparent md:p-0 lg:px-12 md:justify-evenly">
              ...
              <div className="mt-2 md:mx-6">
                ...
                <p className="mt-4 text-lg leading-relaxed dark:text-move-white text-move-white md:text-xl"> 

export function BotaoTrocarDeContabilidade() {
  return (
    <button className="text-move-gray-100 bg-move-blue-900 xl  rounded-xl text-sm text-center lg:text-base group">
      <a
        ...
        href="https://api.whatsapp.com/send?phone=5547988856568&text=Olá.%20Gostaria%20de%20saber%20mais%20sobre%20troca%20de%20contabilidade."
        target="_blank"
      >
